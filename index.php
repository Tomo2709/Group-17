<?php
// You need to get the .htaccess file from the cve website provided in week 4 lab, put it in this folder and the site will work
// getHeader is nescessary on all pages for CSS  functionality
getHeader("PetForum");
